...
```bash
oh autopilot add idea "[P10.1] UX: Cập nhật thông báo trang Chat" --body "Cập nhật trang Chat để hiển thị lời chào hoặc thông tin session thay vì 'Waiting for backend...' khi đã kết nối thành công."

oh autopilot add idea "[P10.2] UI: Syntax highlighting cho Autopilot Policy" --body "Tích hợp syntax highlighting (YAML) cho trình chỉnh sửa Autopilot Policy thay vì dùng textarea thuần."

oh autopilot add idea "[P10.3] UX: Thêm Skeleton loader cho trang History" --body "Thay thế văn bản 'Loading history...' bằng component Skeleton loader trên trang History để tăng trải nghiệm mượt mà."

oh autopilot add idea "[P10.4] UI: Status styling cho Background Jobs" --body "Thêm màu sắc và icon tương ứng theo trạng thái cho các dòng trong bảng Background Jobs (xanh cho Hoàn thành, đỏ cho Lỗi, vàng cho Đang chạy)."

oh autopilot add idea "[P10.5] UI: Cải thiện input 'Passes' trong Modes Settings" --body "Chuyển đổi ô nhập 'Passes' trong cài đặt Modes từ text input sang number input hoặc slider với giới hạn min=1, max=5."

oh autopilot add idea "[P10.6] UX: Thêm liên kết Docs/Help vào Sidebar" --body "Thêm liên kết 'Docs' hoặc 'Help' vào sidebar dẫn đến tài liệu hướng dẫn sử dụng."

oh autopilot add idea "[P10.7] UX: Nút Copy cho Task Description trong History" --body "Thêm nút 'Copy' vào từng mục trong lịch sử để người dùng dễ dàng sao chép lại mô tả nhiệm vụ (task description)."

oh autopilot add idea "[P10.8] UI: Tối ưu layout phần Status trong Sidebar" --body "Cải thiện visual hierarchy cho phần Status trong sidebar để dễ đọc hơn bằng cách sử dụng icon hoặc phân tách nhóm rõ ràng hơn thay vì hiển thị dày đặc văn bản."
```
...
**Tổng cộng**: 84 tasks (P0=3, P1=8, P2=6, P3=6, P4=7, P5=10, P6=8, P7=8, P8=7, P9=11, P10=8, Cross=2)
